...
require_once __DIR__ . '/errorsCatcher.php';
...
class Setup
{
    ...
    static function localizeJS()
    {
        $clickerVoltVars = [
            'urls' => [
                'home' => URLTools::fixMixedContent(get_site_url()),
                'plugin' => URLTools::fixMixedContent(plugins_url() . '/clickervolt'),
                'ajax' => URLTools::fixMixedContent(admin_url('admin-ajax.php')),
            ],
            ...
            'const' => [
                ...
                'FraudDetectionModes' => json_encode([
                    'NONE' => \ClickerVolt\Link::FRAUD_DETECTION_MODE_NONE,
                    'RECAPTCHA_V3' => \ClickerVolt\Link::FRAUD_DETECTION_MODE_RECAPTCHA_V3,
                    'HUMAN' => \ClickerVolt\Link::FRAUD_DETECTION_MODE_HUMAN,
                ]),
                ...
                'ConvIPNURLTemplate' => json_encode(PixelInfo::getIPNURL('-INTEGRATION_NAME-', '-CID-', '-TYPE-', '-NAME-', '-REV-')),
                'CVSettings' => json_encode(self::get_class_consts('ClickerVolt\\CVSettings')),
            ],
            'settings' => [
                'fraudOptions' => [
                    'mode' => CVSettings::get(CVSettings::FRAUD_DETECTION_MODE, \ClickerVolt\Link::FRAUD_DETECTION_MODE_NONE),
                    'recaptcha3SiteKey' => CVSettings::get(CVSettings::RECAPTCHA3_SITE_KEY),
                    'recaptcha3SecretKey' => CVSettings::get(CVSettings::RECAPTCHA3_SECRET_KEY),
                    'recaptcha3HideBadge' => CVSettings::get(CVSettings::RECAPTCHA3_HIDE_BADGE),
                ],
