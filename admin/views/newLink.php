...
require_once __DIR__ . '/../../others/device-detector/Parser/Device/AbstractDeviceParser.php';
                ...
                <tr>
                    ...
                    <td id="td-all-settings">
                        ...
                        <div id="tabs-for-link-edit" class="tabs-wrapper">
                                        ...
                                        <tr>
                                            ...
                                            <td id="default-path">
                                                <table id="target-urls-template" class="target-urls" style="display: none;">
                                                                ...
                                                                <div class="url-variables" style="display: none;">
                                                                    <table>
                                                                        ...
                                                                        <tfoot>
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <a class="button add-url-variable">+ Variable</a>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td colspan="2"><a class="button add-url">+ URL</a></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </td>
                                            ...
                                            <div class="rule-values">
                                                ...
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_DEVICE_BRAND ?>" style="display: none;">
                                                    <select class="rule-value" multiple="true" placeholder="Select Operating Systems...">
                                                        <?php
                                                        foreach (DeviceDetector\Parser\Device\AbstractDeviceParser::$deviceBrands as $code => $name) {
                                                            if ($name != 'Unknown') {
                                                ...
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE ?>" style="display: none;">
                                                    <select class="rule-value" multiple="true" placeholder="Select sources...">
                                                        <?php
                                                        $table = new \ClickerVolt\TableSourceTemplates();
                                                        foreach ($table->loadIdsToNames() as $id => $name) {
                                                ...
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V1 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V2 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V3 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V4 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V5 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V6 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V7 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V8 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V9 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                                <div class="for-<?= ClickerVolt\Rules::RULE_TYPE_SOURCE_VAR_V10 ?>" style="display: none;">
                                                    <input class="rule-value" type="text">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="tab-link-hooks" class="tab-content">
                                <div class="hook-panel redirect template" style="display: none;">
                                    ...
                                    <div class="hook-redirect-params html" style="display: none;">
                                        <p>You can use any of the dynamic tokens in the code content (such as [geo-country] etc...)</p>
                            ...
                            <div id="tab-link-bot-detection" class="tab-content"></div>
...
<script>
    ...
    class ClickerVoltLinkController {
        ...
        static resetLinkFields() {
            ...
            ClickerVoltLinkController.initLinkFields({
                ...
                settings: {
                    ...
                    hooks: [],
                    aliases: [],
                    fraudOptions: clickerVoltVars.settings.fraudOptions,
                },
        ...
        static initLinkFields(link) {
            ...
            jQuery('#tab-link-bot-detection').empty();
            new FraudDetectionHtml(jQuery('#tab-link-bot-detection'), link.settings.fraudOptions);
                    ...
                    ClickerVoltFunctions.ajax('wp_ajax_clickervolt_save_link', form, {
                        ...
                        success: function(response) {
                            ...
                            if (response['recaptcha']) {
                                ...
                                clickerVoltVars.settings.fraudOptions.recaptcha3SiteKey = response['recaptcha']['recaptcha3SiteKey'];
                                clickerVoltVars.settings.fraudOptions.recaptcha3SecretKey = response['recaptcha']['recaptcha3SecretKey'];
                                clickerVoltVars.settings.fraudOptions.recaptcha3HideBadge = response['recaptcha']['recaptcha3HideBadge'];
                            }
        ...
        static addNewRedirectRuleConditionBlock($toRedirectRuleBlock) {
            ...
            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE] = {
                name: "Source",
                operators: ["is", "is-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V1] = {
                name: "Source Var [v1]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V2] = {
                name: "Source Var [v2]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V3] = {
                name: "Source Var [v3]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V4] = {
                name: "Source Var [v4]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V5] = {
                name: "Source Var [v5]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V6] = {
                name: "Source Var [v6]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V7] = {
                name: "Source Var [v7]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V8] = {
                name: "Source Var [v8]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V9] = {
                name: "Source Var [v9]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };

            rules[clickerVoltVars.const.RedirectRules.RULE_TYPE_SOURCE_VAR_V10] = {
                name: "Source Var [v10]",
                operators: ["is", "is-not", "contains", "contains-not", "empty", "empty-not"],
            };
        ...
        static getNewTargetUrlsBlock(blockName) {
            ...
            $clone.find('.button.add-url').on('click', function() {
        ...
        static initAffiliateNetworks($urlBlock) {
            ...
            $select.on('change', function() {
                ...
                if (network) {
                    if (network.getTID().indexOf(cidToken) == -1) {
                        ...
                        // The TID contains the [cid] token... it's not a query variable, but rather
                        // a string to append to the URL...
                        var $urlInput = $urlBlock.find('input.url');
                        $urlInput.val($urlInput.val() + network.getTID());
                    }
