    ...
    static function getRemoteTrackingScript($slug, $options = [])
    {
        ...
        if ($options['forceRecache'] || !file_exists($path)) {
            ...
            $tokens = [
                ...
                '#TOKEN_CVTRACK_JS_URL#' => "//#TOKEN_CVTRACK_JS_DOMAIN#{$pluginPath}/redirect/jsTracking/js/cvTrack.min.js?v={$version}",
            ];
