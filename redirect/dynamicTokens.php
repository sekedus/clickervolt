...
{
    const TOKEN_CID = '[cid]';
    const TOKEN_COUNTRY_CODE = '[geo-country-code]';
            ...
            foreach (self::TOKENS as $token) {
                if (strpos($string, $token) !== false) {
                    ...
                    switch ($token) {
                        ...
                        case self::TOKEN_COUNTRY_CODE: {
                                $geoIp = $this->getGeoIP();
                                $replacePairs[$token] = $geoIp->getCountryCode();
                            }
                            break;
                        ...
                        case self::TOKEN_SESSION: {
                                $replacePairs[$token] = Session::getSessionId();
                            }
                            break;
                    }
                }
