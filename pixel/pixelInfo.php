...
class PixelInfo
{
    ...
    {
        $url = self::getURL("/pixel/do.php", null, $defaultType, $defaultName, $defaultRevenue, $defaultSlug);
    ...
    {
        return self::getURL("/pixel/do.php", $defaultCID, $defaultType, $defaultName, $defaultRevenue);
    }

    /**
     * 
     */
    static function getIPNURL($defaultIntegrationName = 'ipn', $defaultCID = '', $defaultType = '', $defaultName = '', $defaultRevenue = '')
    {
        return self::getURL("/pixel/ipn/{$defaultIntegrationName}.php", $defaultCID, $defaultType, $defaultName, $defaultRevenue);
    }

    /**
     * 
     */
    private static function getURL($scriptPath, $defaultCID = '', $defaultType = '', $defaultName = '', $defaultRevenue = '', $defaultSlug = '')
    {
        ...
        return URLTools::getPluginURL() . "{$scriptPath}?{$queries}";
    }
}
