...
if ( function_exists( '\\ClickerVolt\\cli_fs' ) ) {
    cli_fs()->set_basename( false, __FILE__ );
    return;
}
...
if ( is_admin() || defined( 'DOING_AJAX' ) || defined( 'DOING_CRON' ) ) {
    ...
    add_action( 'wp_ajax_clickervolt_get_all_custom_reports', [ 'ClickerVolt\\AjaxStats', 'getAllCustomReportsAjax' ] );
    add_action( 'wp_ajax_clickervolt_save_custom_report', [ 'ClickerVolt\\AjaxStats', 'saveCustomReportsAjax' ] );
    add_action( 'wp_ajax_clickervolt_delete_custom_report', [ 'ClickerVolt\\AjaxStats', 'deleteCustomReportAjax' ] );
    add_action( 'wp_ajax_clickervolt_purge_all_stats', [ 'ClickerVolt\\AjaxStats', 'purgeAllStatsAjax' ] );
    add_action( 'wp_ajax_clickervolt_purge_raw_clicks', [ 'ClickerVolt\\AjaxStats', 'purgeRAWClicksAjax' ] );
