...
class Link implements Proxyable
{
    ...
    public function getHTMLHooks($hookWhen = null, $resolveTokens = false)
    {
        $htmlContent = [];
        ...
        if ($resolveTokens) {
            ...
            foreach ($htmlContent as $k => $html) {
                $htmlContent[$k] = $dynamicTokens->replace($html, false);
            }
        }
...
class TableLinks extends Table
{
    ...
    public function insert($link)
    {
        ...
        if (empty($link->getSlug())) {
            throw new \Exception("Cannot save link with empty slug");
        }
    ...
    public function update($link)
    {
        ...
        if (empty($link->getSlug())) {
            throw new \Exception("Cannot update link with empty slug");
        }
