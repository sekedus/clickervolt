...
class ArrayVars
{
     ...
     * @param string $pathSeparator - to override the path separator
     */
    static function getFromPath($array, $path, $default = null, $pathSeparator = '/')
    {
        $val = $default;
     ...
     * 
     */
    static function setFromPath(&$array, $path, $value, $pathSeparator = '/')
    {
        $keys = explode($pathSeparator, $path);
        $nbKeys = count($keys);
